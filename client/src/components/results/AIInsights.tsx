...
export default function AIInsights({ isLoading, insights, recommendations, onRefresh }: AIInsightsProps) {  
  if (!isLoading && !insights && !recommendations) return null;
    
  return (
    <div className="bg-white rounded-lg shadow-sm h-full">
      <div className="border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <AIIcon size={18} className="text-secondary-500" />
          <h2 className="text-sm font-medium text-gray-800">AI Analysis & Insights</h2>
        </div>
        <div>
          <button 
