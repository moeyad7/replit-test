...
export const LoyaltyIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    width={size} 
    height={size}
    viewBox="0 0 24 24" 
    ...
    {...props}
  >
    <path d="M10 11h-4a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h3.5a1 1 0 0 1 1 1v.5" />
    <path d="M13 7.5v-3a1 1 0 0 1 1 -1h3.5a1 1 0 0 1 1 1v3a1 1 0 0 1 -1 1h-3.5" />
    <path d="M8 13v-4" />
    <path d="M13.4 19h-5.4a2 2 0 0 1 -2 -2v-6h6" />
    <path d="M13.5 19l4 -6" />
    <path d="M16 19h3" />
  </svg>
);
...
export const CustomersIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    width={size} 
    height={size}
    viewBox="0 0 24 24" 
...
export const PointsIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    width={size} 
    height={size}
    viewBox="0 0 24 24" 
...
export const ChallengesIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    width={size} 
    height={size}
    viewBox="0 0 24 24" 
    ...
    {...props}
  >
    <path d="M6 9h12a6 6 0 0 1 0 12H4a4 4 0 0 0 4-4V5a2 2 0 0 1 4 0v7" />
  </svg>
);
...
export const TranslateIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    width={size} 
    height={size}
    viewBox="0 0 24 24" 
...
export const AIIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    width={size} 
    height={size}
    viewBox="0 0 24 24" 
  ...
  >
    ...
    <path d="M9.5 2A14.5 14.5 0 0 1 9.5 22" />
    <path d="M14.5 2A14.5 14.5 0 0 0 14.5 22" />
  </svg>
);
